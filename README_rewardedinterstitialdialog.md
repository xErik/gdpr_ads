# Rewarded Interstitial Dialog

Copy this dialog into your project and skin the `AlertDialog` inside to match your app's desgin.

<include file="example/example_flutter/lib/rewaredinterstitialdialog.dart">
